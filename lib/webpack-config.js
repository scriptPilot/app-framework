  ...
  config.plugins.push(
    new webpack.DefinePlugin({
      'process.env': {
        ...
        USE_FIREBASE_APP: '"' + (env.cfg.firebase.useDatabaseService === true || env.cfg.firebase.useStorageService === true || env.cfg.firebase.useEmailLogin === true) + '"',
        USE_FIREBASE_AUTH: '"' + (env.cfg.firebase.useEmailLogin === true) + '"',
        USE_FIREBASE_DATABASE: '"' + (env.cfg.firebase.useDatabaseService) + '"',
        USE_FIREBASE_STORAGE: '"' + (env.cfg.firebase.useStorageService === true) + '"',
