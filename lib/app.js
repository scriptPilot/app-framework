...
let rememberAndRestoreData = {
  created: function () {
    if (this.$options._componentTag === undefined && this.$parent && this.$parent.$options._componentTag === 'f7-pages') {
  ...
  updated: function () {
    if (this.$options._componentTag === undefined && this.$parent.$options._componentTag === 'f7-pages') {
