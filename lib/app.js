...
if (process.env.USE_FIREBASE_APP === 'true') require('firebase/app')
...
function restoreTheme (app, callback) {
  ...
  app.statusbarVisibility = window.localStorage.statusbarVisibility === 'hidden' ? 'hidden' : 'visible'
  callback()
}
