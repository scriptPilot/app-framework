<template><div data-page="swiper-horizontal" class="page"><div class="navbar">
  <div class="navbar-inner">
    ...
    <div class="page-content">
      <div data-pagination=".swiper-pagination" data-space-between="50" data-pagination-hide="true" class="swiper-container swiper-init ks-demo-slider">
