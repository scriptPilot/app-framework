<template><div data-page="timeline" class="page"><div class="navbar">
  <div class="navbar-inner">
    ...
    <div class="page-content">
      <div class="list-block">
        <ul>
          <li><a href="/f7ios/timeline-vertical/" class="item-content item-link">
              <div class="item-inner">
                <div class="item-title">Vertical Timeline</div>
                <div class="item-after"><span class="badge bg-green">NEW</span></div>
              </div></a></li>
          <li><a href="/f7ios/timeline-horizontal/" class="item-content item-link">
              <div class="item-inner">
                <div class="item-title">Horizontal Timeline</div>
                <div class="item-after"><span class="badge bg-green">NEW</span></div>
              </div></a></li>
          <li><a href="/f7ios/timeline-horizontal-calendar/" class="item-content item-link">
              <div class="item-inner">
