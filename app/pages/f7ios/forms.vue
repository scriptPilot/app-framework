<template><div data-page="forms" class="page"><div class="navbar">
  <div class="navbar-inner">
    ...
    <div class="page-content">
      ...
      <div class="list-block">
        <ul>
          <li><a href="/f7ios/forms-elements/" class="item-link">
          ...
          <li><a href="/f7ios/forms-checkboxes/" class="item-link">
              <div class="item-content">
                <div class="item-media"><i class="icon icon-f7"></i></div>
                <div class="item-inner"> 
          ...
          <li><a href="/f7ios/forms-selects/" class="item-link">
              <div class="item-content">
                <div class="item-media"><i class="icon icon-f7"></i></div>
                <div class="item-inner"> 
          ...
          <li><a href="/f7ios/forms-buttons/" class="item-link">
              <div class="item-content">
                <div class="item-media"><i class="icon icon-f7"></i></div>
                <div class="item-inner"> 
          ...
          <li><a href="/f7ios/forms-storage/" class="item-link">
              <div class="item-content">
                <div class="item-media"><i class="icon icon-f7"></i></div>
                <div class="item-inner"> 
