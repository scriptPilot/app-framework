<template><div data-page="modals" class="page"><div class="navbar">
  <div class="navbar-inner">
    ...
    <div class="page-content">
      ...
      <div class="content-block">
        <div class="content-block-inner">
          <p>Such overlay type is similar to <a href="/f7ios/picker/">Picker's</a> overlay, but also allows to create custom picker overlays</p>
