<template><div data-page="swiper-3d-coverflow" class="page"><div class="navbar">
  <div class="navbar-inner">
    <div class="left sliding"><a href="/f7ios/swiper/" class="back link"><i class="icon icon-back"></i><span>Back</span></a></div>
    <div class="center sliding">3D Coverflow Effect</div>
    <div class="right"><a href="#" class="open-panel link icon-only"><i class="icon icon-bars"></i></a></div>
  </div>
</div>
    <div class="page-content">
      <div data-pagination=".swiper-pagination" data-effect="coverflow" data-slides-per-view="auto" data-centered-slides="true" class="swiper-container swiper-init ks-demo-slider ks-coverflow-slider">
