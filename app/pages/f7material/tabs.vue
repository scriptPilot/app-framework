<template><div data-page="tabs" class="page">
  <div class="navbar">
  ...
  <div class="page-content">
    <div class="list-block">
      <ul>
        <li><a href="/f7material/tabs-static/" class="item-content item-link">
            <div class="item-media"><i class="icon icon-f7"></i></div>
            <div class="item-inner">
              <div class="item-title">Static Tabs</div>
            </div></a></li>
        <li><a href="/f7material/tabs-animated/" class="item-content item-link">
            <div class="item-media"><i class="icon icon-f7"></i></div>
            <div class="item-inner">
              <div class="item-title">Animated Tabs</div>
            </div></a></li>
        <li><a href="/f7material/tabs-swipeable/" class="item-content item-link">
            <div class="item-media"><i class="icon icon-f7"></i></div>
            <div class="item-inner">
