<template><div data-page="progressbar" class="page">
  <div class="navbar">
  ...
  <div class="page-content">
    <div class="content-block">
      <p>In addition to <a href="/f7material/preloader/">Preloader</a>, Framework7 also comes with fancy animated determinate and infinite/indeterminate progress bars to indicate some activity.</p>
    </div>
