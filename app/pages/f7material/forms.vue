<template><div data-page="forms" class="page">
  <div class="navbar">
  ...
  <div class="page-content">
    ...
    <div class="list-block">
      <ul>
        <li><a href="/f7material/forms-elements/" class="item-link">
        ...
        <li><a href="/f7material/forms-checkboxes/" class="item-link">
            <div class="item-content">
              <div class="item-media"><i class="icon icon-f7"></i></div>
              <div class="item-inner"> 
        ...
        <li><a href="/f7material/forms-selects/" class="item-link">
            <div class="item-content">
              <div class="item-media"><i class="icon icon-f7"></i></div>
              <div class="item-inner"> 
        ...
        <li><a href="/f7material/forms-buttons/" class="item-link">
            <div class="item-content">
              <div class="item-media"><i class="icon icon-f7"></i></div>
              <div class="item-inner"> 
        ...
        <li><a href="/f7material/forms-storage/" class="item-link">
            <div class="item-content">
              <div class="item-media"><i class="icon icon-f7"></i></div>
              <div class="item-inner"> 
