<template><div data-page="timeline-vertical" class="page">
  <div class="navbar">
    <div class="navbar-inner">
      <div class="left sliding"><a href="/f7material/index/" class="back link"><i class="icon icon-back"></i></a></div>
      <div class="center sliding">Vertical Timeline</div>
      <div class="right"><a href="#" class="link open-panel icon-only"><i class="icon icon-bars"></i></a></div>
    </div>
  </div>
  <div class="page-content">
    <div class="content-block-title">Default</div>
    <div class="timeline">
    ...
    <div class="content-block-title">Side By Side</div>
    ...
    <div class="content-block-title">Only Tablet Side By Side</div>
    ...
    <div class="content-block-title">Forced Sides</div>
    <div class="timeline timeline-sides">
    ...
    <div class="content-block-title">Rich Content</div>
    <div class="timeline">
      <div class="timeline-item">
        <div class="timeline-item-date">21 <small>DEC</small></div>
        <div class="timeline-item-divider"></div>
    ...
    <div class="content-block-title">Inside Content Block</div>
