<template><div data-page="chips" class="page">
  <div class="navbar">
  ...
  <div class="page-content">
    ...
    <div class="content-block">
      ...
      <div class="chip">
        <div class="chip-media bg-purple"><i class="icon material-icons">email</i></div>
        <div class="chip-label">Sent</div>
      </div>
      <div class="chip">
        <div class="chip-media bg-red"><i class="icon material-icons">file_upload</i></div>
