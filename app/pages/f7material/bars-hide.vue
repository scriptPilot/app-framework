<template>
  <div data-page="hide-navbar-toolbar" class="page kitchen-sink-material">
    <div class="navbar">
    ...
    <div class="page-content">
      ...
      <div class="list-block">
        <ul>
          <li>
            <a href="/f7material/bars-no-navbar/" class="item-link">
          ...
          <li>
            <a href="/f7material/bars-no-toolbar/" class="item-link">
              <div class="item-content">
                <div class="item-media"><i class="icon icon-f7"></i></div>
                <div class="item-inner">
          ...
          <li>
            <a href="/f7material/bars-no-navbar-toolbar/" class="item-link">
              <div class="item-content">
                <div class="item-media"><i class="icon icon-f7"></i></div>
                <div class="item-inner">
