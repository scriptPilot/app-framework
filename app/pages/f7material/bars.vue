<template><div data-page="navbars-toolbars" class="page">
  <div class="navbar">
  ...
  <div class="page-content">
    <div class="list-block">
      <ul>
        <li><a href="/f7material/bars-tabbar/" class="item-link">
        ...
        <li><a href="/f7material/bars-tabbar-labels/" class="item-link">
            <div class="item-content">
              <div class="item-media"><i class="icon icon-f7"></i></div>
              <div class="item-inner">
        ...
        <li><a href="/f7material/bars-tabbar-scrollable/" class="item-link">
            <div class="item-content">
              <div class="item-media"><i class="icon icon-f7"></i></div>
              <div class="item-inner">
        ...
        <li><a href="/f7material/bars-hide-on-scroll/" class="item-link">
            <div class="item-content">
              <div class="item-media"><i class="icon icon-f7"></i></div>
              <div class="item-inner">
        ...
        <li><a href="/f7material/bars-sub-navbar/" class="item-link">
            <div class="item-content">
              <div class="item-media"><i class="icon icon-f7"></i></div>
              <div class="item-inner">
        ...
        <li><a href="/f7material/bars-sub-navbar-title/" class="item-link">
            <div class="item-content">
              <div class="item-media"><i class="icon icon-f7"></i></div>
              <div class="item-inner">
        ...
        <li><a href="/f7material/bars-toolbar-bottom/" class="item-link">
            <div class="item-content">
              <div class="item-media"><i class="icon icon-f7"></i></div>
              <div class="item-inner">
