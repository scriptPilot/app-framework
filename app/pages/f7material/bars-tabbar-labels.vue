<template><div data-page="tabbar-labels" class="page tabbar-labels-fixed">
  <div class="navbar">
  ...
  <div class="toolbar tabbar tabbar-labels">
    <div class="toolbar-inner"><a href="#tab-1" class="tab-link active"><i class="icon material-icons">email</i><span class="tabbar-label">Inbox</span></a><a href="#tab-2" class="tab-link"><i class="icon material-icons">today</i><span class="tabbar-label">Calendar</span></a><a href="#tab-3" class="tab-link"><i class="icon material-icons">file_upload</i><span class="tabbar-label">Upload</span></a></div>
  </div>
