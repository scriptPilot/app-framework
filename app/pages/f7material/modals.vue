<template>
  <div data-page="modals" class="page kitchen-sink-material">
    <div class="navbar">
    ...
    <div class="page-content">
      ...
      <div class="content-block">
        <p>Such overlay type is similar to <a href="/f7material/picker/">Picker's</a> overlay, but also allows to create custom picker overlays</p>
