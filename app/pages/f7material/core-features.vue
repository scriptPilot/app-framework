<template>
  <div data-page="core-features" class="page kitchen-sink-material">
    <div class="navbar">
      <div class="navbar-inner">
        <div class="left"><a class="back link icon-only" href="#"><i class="icon icon-back"></i></a></div>
        <div class="center">Core Features</div>
      </div>
    </div>
    <div class="page-content">
      ...
      <div class="content-block">
        <p>It can sound even curious but one of the most important Framework7 feature is that it uses only native scrolling. Moreover - it multiplies its advantages! So you can still have this awesome scrolling with momentum and resistance bounce without any
          scrolling issues!</p>
      </div>
      ...
      <div class="content-block-title">High-performance Animations</div>
      <div class="content-block">
      ...
      <div class="content-block">
        <p>With Framework7 everything is simple, all styles are divided by parts into small .less files, so you can really easy bring your own custom styles to your app</p>
      </div>
    </div>
  </div>
</template>
